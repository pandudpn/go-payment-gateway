...
const (
	// EWalletDANA is Payment Type or Channel Code for e-wallet DANA Indonesia from Xendit API
	// DANA supporting for payment:
	//  - One Time Payment
	//  - Linked Account (Tokenized)
	EWalletDANA ChannelCode = "ID_DANA"

	// EWalletOVO is Payment Type or Channel Code for e-wallet OVO from Xendit API
	// OVO supporting for payment:
	//  - One Time Payment
	//  - Linked Account (Tokenized)
	EWalletOVO ChannelCode = "ID_OVO"

	// EWalletShopeePay is Payment Type or Channel Code for e-wallet ShopeePay from Xendit API
	// ShopeePay supporting for payment:
	//  - One Time Payment
	//  - Linked Account (Tokenized)
	EWalletShopeePay ChannelCode = "ID_SHOPEEPAY"

	// EWalletLinkAja is Payment Type or Channel Code for e-wallet LinkAja from Xendit API
	// LinkAja only support One Time Payment
	EWalletLinkAja ChannelCode = "ID_LINKAJA"
)
