...
import (
	...
	midtrans "github.com/pandudpn/go-payment-gateway/internal/midtrans"
...
func (_m *PaymentInterface) Do(ctx context.Context) (*midtrans.ChargeResponse, error) {
	ret := _m.Called(ctx)

	var r0 *midtrans.ChargeResponse
	if rf, ok := ret.Get(0).(func(context.Context) *midtrans.ChargeResponse); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*midtrans.ChargeResponse)
		}
	}
